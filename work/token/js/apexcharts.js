  ...
  function () {
    ...
    _createClass(DateTime, [{
      ...
      value: function parseDate(dateStr) {
        ...
        var output = Date.parse(dateStr.replace(/-/g, '../index.html').replace(/[a-z]+/gi, ' '));
        ...
        return {
          ...
          tooltip: {
            ...
            custom: function custom(_ref) {
              ...
              return '<div class="apexcharts-tooltip-candlestick">' + '<div>시가: <span class="value">' + o + '</span></div>' + '<div>고가: <span class="value">' + h + '</span></div>' + '<div>저가: <span class="value">' + l + '</span></div>' + '<div>종가: <span class="value">' + c + '</span></div>' + '</div>';
            }
          },
          states: {
            active: {
